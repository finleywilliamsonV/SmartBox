package {
	...
	public class TagLibrary_Tag extends MovieClip {
		...
		public function TagLibrary_Tag(text: String = "TAG TAG TAG TAG TAG TAG TAG "): void {
			...
			tagContainer.graphics.beginFill(0xEEEEEE);
